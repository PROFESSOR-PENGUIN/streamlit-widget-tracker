...
import streamlit_text_like

def start_tracking(exclude_key=None):
    widget_values = {}
    ...
    streamlit_text_like.streamlit_text_like=widget_wrapper(streamlit_text_like.streamlit_text_like,exclude_key)
